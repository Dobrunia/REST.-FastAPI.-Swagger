...
class GlossaryServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.DeleteTerm = channel.unary_unary(
                ...
                request_serializer=glossary__pb2.TermRequest.SerializeToString,
                response_deserializer=glossary__pb2.OperationResult.FromString,
                _registered_method=True)
...
def add_GlossaryServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'DeleteTerm': grpc.unary_unary_rpc_method_handler(
                    servicer.DeleteTerm,
                    request_deserializer=glossary__pb2.TermRequest.FromString,
                    response_serializer=glossary__pb2.OperationResult.SerializeToString,
            ),
    }
...
class GlossaryService(object):
    ...
    def DeleteTerm(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/glossary.GlossaryService/DeleteTerm',
            glossary__pb2.TermRequest.SerializeToString,
            glossary__pb2.OperationResult.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
